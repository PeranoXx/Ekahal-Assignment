...
<main class="flex-1 p-margin-desktop max-w-6xl mx-auto w-full">
    <!-- Page Header -->
    <div class="mb-xl">
        <h2 class="font-headline-lg text-headline-lg text-primary tracking-tight mb-xs">Add New Product</h2>
        <p class="font-body-md text-body-md text-on-surface-variant">Create a new product listing in the inventory and configure price and stock.</p>
    </div>

    <!-- Form Card -->
    <div class="bg-surface-container-lowest border border-outline-variant rounded-lg p-lg shadow-sm">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-lg">
            @csrf
